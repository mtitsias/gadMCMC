function demo_radfordnealexample_adaptive_mala_fast(rep, Optimizer)
...
outName = ['radfordneal_adaptive_mala_optim' num2str(Optimizer)];
...
if storeRes == 1
  save(['../results/' outName '_repeat' num2str(rep) '.mat'], 'summary_adaptive_mala');
end
